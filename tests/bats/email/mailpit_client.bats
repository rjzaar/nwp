...
setup() {
    ...
    # F23 Phase 8: email library moved to servers/nwpcode/email/. Legacy fallback retained.
    LIBRARY="${PROJECT_ROOT}/servers/nwpcode/email/lib/mailpit-client.sh"
    [ -f "$LIBRARY" ] || LIBRARY="${PROJECT_ROOT}/email/lib/mailpit-client.sh"
