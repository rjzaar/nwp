...
- Create the `sites/<name>/web/modules/custom` directory
- Clone the module into `sites/<name>/web/modules/custom/my_module`
...
- Clone git modules to `sites/<name>/web/modules/custom/`
...
See `servers/nwpcode/linode/gitlab/README.md` for complete GitLab documentation.
