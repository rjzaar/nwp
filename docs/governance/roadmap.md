...
> - Phase 14: F23 (Site Environment Layout — dev/+stg/ restructure)
...
| P77 | Clip-retrieval evaluation harness | PROPOSED (nwp/ops#348; measures the P76 retrieval engine) |
...
| | **Phase 14: Site Environment Layout — ✅ Complete** | | |
| 21 | F23 | **✅ COMPLETE** | Sites restructured to dev/+stg/ subdirs, sync scripts fixed, -stg siblings absorbed (2026-04-09) |
| | **Next: Backup + Tooling (Phase 15)** | | *F18 now unblocked* |
