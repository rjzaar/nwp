...
| [0034](0034-erasure-propagation-op-to-rp.md) | Erasure propagation nwc (OP) → ss/ssc (RP) | 2026-07-28 | **Proposed** — bespoke signed channel over the P74 contract machinery, not OpenID Provider Commands (draft-02); staged path with the operator runbook as the standing fallback (nwp/ops#81) |
