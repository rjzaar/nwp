...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\config_modify\ConfigInstaller' "profiles/contrib/social/modules/custom/config_modify/src/".
 */

namespace Drupal\config_modify\ProxyClass {

    /**
     * Provides a proxy class for \Drupal\config_modify\AlteredConfigInstaller.
     *
    ...
    class ConfigInstaller implements \Drupal\Core\Config\ConfigInstallerInterface
    {
         ...
         *
         * @var \Drupal\config_modify\ConfigInstaller
         */
        protected $service;
        ...
        {
            $this->lazyLoadItself()->installOptionalConfig($storage, $dependency);
        }

        /**
         * {@inheritdoc}
         */
        public function installOptionalAlterConfig(?\Drupal\Core\Config\StorageInterface $storage = NULL): void
        {
            $this->lazyLoadItself()->installOptionalAlterConfig($storage);
        }
