...
# (auth_nwc_oauth2). The per-tier issuer URL comes from the PAIR CONTRACT
...
#
# Write the tier-aware auth_nwc_oauth2 issuer DESCRIPTOR the promotion pipeline
...
# Applied to the Moodle consumer by the promotion pipeline (auth_nwc_oauth2).
