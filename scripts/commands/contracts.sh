...
#
# Usage: pl contracts <compat|sums|sign|verify|bundle|sync-plan|crossref|erasure> [opts]
################################################################################
...
main() {
    ...
    case "$verb" in
        ...
        -h|--help|help)
            ...
            ;;
        *)
            _err "pl contracts: unknown verb '$verb' (compat|sums|sign|verify|bundle|sync-plan|crossref|erasure)"
            return 2
            ;;
    esac
}
