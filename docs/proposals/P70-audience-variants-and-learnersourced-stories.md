...
**Amended by [NWP-ADR-0027](../decisions/0027-unified-course-content-architecture.md) (2026-07-09):**
...
NWP-ADR-0027's ceremony-scales-with-trust-distance spectrum, and the `audience` vocabulary is fixed to
NWP-ADR-0027 Decision 1.
