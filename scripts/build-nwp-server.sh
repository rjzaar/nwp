...
#
# nwp-server is a BUILD TARGET of the nwp source tree (NWP-ADR-0022 + NWP-ADR-0026), not a
...
# the assembled tree fails the build — the mechanical form of NWP-ADR-0022's
...
# ── Self-describing manifest (deterministic, sorted) ─────────────────────────
{
  ...
  echo "# AI-free build target of nwp (NWP-ADR-0022, NWP-ADR-0026). Capability set:"
