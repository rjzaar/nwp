...
| [0017](0017-distributed-build-deploy-pipeline.md) | Distributed build/deploy pipeline (mmt build, mons deploy) | 2026-04-07 | Accepted (implementation started; F21 Phase 3a ✅) |
